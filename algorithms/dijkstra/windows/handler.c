	...
	switch (mitem) {
		...
		case 'A':	// Mostra códigos dos estádios
			...
			try {
				...
				_perror_block ("ERRO AO MOSTRAR CÓDIGOS DOS ESTÁDIOS", e);
		...
		case '1': //Informações dos estádios
			...
			try {
				...
				_perror_block ("ERRO AO CARREGAR MENU DOS ESTÁDIOS", e);
		...
		case '2': //Matriz de distância
			...
			try {
				...
				_perror_block ("ERRO AO MOSTRAR MATRIZ DE DISTÂNCIA!", e);
		...
		case '3': //Árvore de distância mínima
			...
			try {
				...
				_perror_block ("ERRO AO CALCULAR ÁRVORE DE DISTÂNCIA MÍNIMA!", e);
		...
		case '5': //Caminho mínimo
			...
			try {
				...
				_perror_block ("ERRO AO CALCULAR CAMINHO MÍNIMO!", e);
